    ...
    <section id="skills">
      ...
      <div className="skillBars">
        <div className="skillBar">
          <img src="/images/qatester.jpeg" alt="" className="skillBarImg" />
        ...
        <div className="skillBar">
          <img src="/images/Web2.jpeg" alt="" className="skillBarImg" />
          <div className="skillBarText">
            <h2>Web Designer</h2>
        ...
        <div className="skillBar">
          <img src="/images/App.jpeg" alt="" className="skillBarImg" />
          <div className="skillBarText">
            <h2>App Desiger</h2>
